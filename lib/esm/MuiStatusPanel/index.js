...
var StyledContainer = styled('div')(function (_a) {
    ...
    return ({
        ...
        backgroundColor: "".concat(theme.palette.background.default, "BB"),
...
export default function (_a) {
    ...
    return _jsxs(_Fragment, { children: [_jsx(MuiStatus, __assign({}, {
                id: id,
                tooltip: tooltip,
                ...
                : _jsx(Popper, __assign({}, __assign({ keepMounted: keepOpen }, FallbackPopoverProps), { children: _jsx(ClickAwayListener, __assign({ onClickAway: function () { return handleOnClose(); } }, { children: _jsxs(StyledContainer, __assign({}, { elevation: elevation }, { children: [popover, _jsxs(StyledActionsWrapper, { children: [_jsx(StyledTypography, __assign({ variant: "caption", color: "textSecondary" }, { children: popoverTitle })), _jsxs(StyledActions, { children: [popoverActions, settings.hasLock && _jsx(Tooltip, __assign({ tooltip: "Toggle keep-open" }, { children: keepOpen
