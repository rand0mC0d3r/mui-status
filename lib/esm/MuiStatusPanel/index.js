...
export default function (_a) {
    ...
    return _jsxs(_Fragment, { children: [_jsx(MupStatus, __assign({}, {
                ...
                : _jsx(Popper, __assign({}, __assign({ keepMounted: keepOpen }, FallbackPopoverProps), { children: _jsx(ClickAwayListener, __assign({ onClickAway: function () { return handleOnClose(); } }, { children: _jsxs(StyledContainer, __assign({}, { style: { margin: '8px' } }, { children: [popover, _jsx(StyledLock, __assign({ onClick: function () { return setKeepOpen(!keepOpen); } }, { children: keepOpen
