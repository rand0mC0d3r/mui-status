...
export default function (_a) {
    ...
    return _jsxs(_Fragment, { children: [_jsx(MupStatus, __assign({}, { id: id, tooltip: tooltip, secondary: secondary, onClick: onClick, style: __assign(__assign({}, style), { minWidth: '24px' }) }, { children: children })), popoverComponent !== undefined
                ? popoverComponent(ComponentPopoverProps)
                : _jsx(Popover, __assign({}, __assign(__assign({}, FallbackPopoverProps), { anchorOrigin: { vertical: anchorVertical, horizontal: horizontal }, transformOrigin: { vertical: transformVertical, horizontal: horizontal } }), { children: _jsxs(StyledContainer, { children: [popover, _jsx(StyledLock, __assign({ onClick: function () { return setKeepOpen(!keepOpen); } }, { children: keepOpen
