...
export default function (_a) {
    ...
    return _jsxs(_Fragment, { children: [_jsx(MupStatus, __assign({}, { id: id, tooltip: tooltip, highlight: highlight, secondary: secondary, onClick: onClick, style: __assign(__assign({}, style), { minWidth: '24px' }) }, { children: children })), popoverComponent !== undefined
