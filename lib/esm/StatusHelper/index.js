...
var StyledSvgIcon = styled(SvgIcon)(function (_a) {
    var theme = _a.theme, reverseicon = _a.reverseicon;
    return ({
        fontSize: '14px',
        flex: '0 1 100%',
        color: theme.palette.action.active,
...
export default function (_a) {
    ...
    return _jsxs(StyledBox, __assign({ id: "statusHelper" }, { style: style, className: className, reverse: reverse.toString() }, { children: [icon && _jsx(StyledSvgIcon, __assign({}, { reverseicon: reverseIcon.toString() }, { children: icon })), image && _jsx(StyledImg, __assign({}, { alt: '', mask: mask, src: image })), notifications && _jsx(StyledNotificationsTypography, __assign({}, { variant: 'subtitle2', color: 'textPrimary' }, { children: notifications })), text && _jsx(StyledTypography, __assign({}, { variant: 'caption', color: 'textSecondary' }, { children: text }))] }));
}
