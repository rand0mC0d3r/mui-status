...
var SStack = styled(Stack)(function (_a) {
    var theme = _a.theme, reverse = _a.reverse, startSeparator = _a.startSeparator, endSeparator = _a.endSeparator;
    return ({
        display: 'flex',
        padding: '4px 8px',
        alignItems: 'center',
...
export default function (_a) {
    var icon = _a.icon, text = _a.text, notifications = _a.notifications, image = _a.image, _b = _a.mask, mask = _b === void 0 ? false : _b, _c = _a.reverse, reverse = _c === void 0 ? false : _c, _d = _a.reverseIcon, reverseIcon = _d === void 0 ? false : _d, children = _a.children, _e = _a.childrenIndex, childrenIndex = _e === void 0 ? 1 : _e, className = _a.className, style = _a.style, _f = _a.endSeparator, endSeparator = _f === void 0 ? false : _f, _g = _a.startSeparator, startSeparator = _g === void 0 ? false : _g;
    return _jsxs(SStack, __assign({}, {
        id: 'statusHelper',
        style: style,
        className: className,
