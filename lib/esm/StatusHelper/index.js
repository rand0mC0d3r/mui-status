...
export default function (_a) {
    ...
    return _jsxs(SStack, __assign({}, { id: 'statusHelper', style: style, className: className, reverse: reverse.toString() }, { children: [icon && _jsx(SIcon, __assign({}, { id: 'sh.icon', reverse: reverseIcon.toString() }, { children: icon })), children && _jsx(_Fragment, { children: childrenIndex ? _jsx(SChildren, __assign({}, { index: childrenIndex }, { children: children })) : children }), image && _jsx(SImg, __assign({}, { id: 'sh.image', alt: 'Status entry', mask: mask.toString(), src: image })), notifications && _jsx(SNotifications, __assign({}, { id: 'sh.notifications' }, { children: notifications })), text && _jsx(SText, __assign({}, { id: 'sh.text', variant: 'caption' }, { children: text }))] }));
}
