...
var SStatusWrapper = styled('div')(function (_a) {
    var theme = _a.theme, hasBorder = _a.hasBorder, position = _a.position, width = _a.width;
    return ({
        gap: '4px',
        display: 'flex',
        alignItems: 'stretch',
...
export default function (_a) {
    ...
    var _c = useContext(DataProvider).settings, position = _c.position, upperBar = _c.upperBar, hasBorder = _c.hasBorder, width = _c.width;
