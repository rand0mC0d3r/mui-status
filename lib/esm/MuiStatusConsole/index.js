...
export default function (_a) {
    ...
    var consoleActiveId = useContext(DataProvider).settings.consoleActiveId;
    ...
    return _jsxs(_Fragment, { children: [_jsx(MupStatus, __assign({}, {
                ...
                tooltip: tooltip,
                secondary: secondary,
                highlight: (statusObject && (statusObject === null || statusObject === void 0 ? void 0 : statusObject.uniqueId) === consoleActiveId) ? 'primary' : 'default',
