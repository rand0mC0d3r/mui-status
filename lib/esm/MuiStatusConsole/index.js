...
export default function (_a) {
    var id = _a.id, _b = _a.secondary, secondary = _b === void 0 ? false : _b, style = _a.style, onClick = _a.onClick, _c = _a.tooltip, tooltip = _c === void 0 ? '' : _c, children = _a.children, console = _a.console;
    var _d = useContext(DataProvider), status = _d.status, settings = _d.settings, handleStatusTypeUpdate = _d.handleStatusTypeUpdate, updateConsoleActiveId = _d.updateConsoleActiveId;
