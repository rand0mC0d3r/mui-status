...
export default function (_a) {
    ...
    return _jsxs(_Fragment, { children: [_jsx(Status, __assign({}, {
            ...
            }, { children: _jsx(ClickAwayListener, __assign({ onClickAway: function () { return handleOnClose(); } }, { children: _jsxs(StyledContainer, __assign({}, { elevation: elevation }, { children: [_jsx("div", __assign({ style: { position: 'absolute', top: '-17px', left: '0px', right: '0px', display: 'flex', justifyContent: 'center' } }, { children: _jsx(ArrowDropUpOutlinedIcon, { color: "primary" }) })), popover, _jsxs(StyledActionsWrapper, { children: [_jsx(StyledTypography, __assign({ variant: "caption", color: "textSecondary" }, { children: popoverTitle })), _jsxs(StyledActions, { children: [popoverActions, settings.hasLock && _jsx(Tooltip, __assign({ title: "Toggle keep-open" }, { children: keepOpen
