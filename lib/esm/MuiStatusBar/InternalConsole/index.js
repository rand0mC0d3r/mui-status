...
export default function () {
    ...
    var _b = settings, consoleActiveId = _b.consoleActiveId, isConsoleOpen = _b.isConsoleOpen;
    ...
    return _jsx(_Fragment, { children: (consoleActiveId || isConsoleOpen) && _jsx(_Fragment, { children: status.some(function (_a) {
                var type = _a.type;
                return type === relevantType;
            }) && _jsxs(StyledWrapper, __assign({}, { id: domIdWrapper }, { children: [_jsxs(StyledActionsWrapper, { children: [_jsx(StyledTabs, { children: relevantConsoles.map(function (_a) {
                        ...
                        : _jsxs("div", { children: [_jsx(AppsOutageIcon, {}), _jsx(Typography, __assign({ variant: "caption" }, { children: "Seems no consoles available. Select one from above" }))] })] })) }) });
}
