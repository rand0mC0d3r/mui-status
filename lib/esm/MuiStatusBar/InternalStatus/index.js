...
export default function () {
    ...
    return _jsxs(_Fragment, { children: [status.some(function (_a) {
                ...
                var type = _a.type;
                return type === 'console';
            }) && _jsx(Tooltip, __assign({}, { tooltip: 'Toggle console view' }, { children: _jsx(StyledKeyboardDoubleArrowUpIcon, __assign({}, { onDoubleClick: function () { return updateIsConsoleOpen(); } })) })), status.some(function (_a) {
                var secondary = _a.secondary;
                return secondary;
