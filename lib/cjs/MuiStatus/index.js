...
var StyledContainer = (0, styles_1.styled)('div')(function (_a) {
    ...
    return ({
        ...
        '&:hover': {
            backgroundColor: (hasClick && !isDisabled) ? "".concat(highlight === 'default' ? theme.palette.divider : onHoverBg(highlight, theme), " !important") : '',
            color: (hasClick && !isDisabled) ? "".concat(theme.palette.background.default, " !important") : '',
        },
    });
});
function default_1(_a) {
    ...
    var _f = (0, react_1.useContext)(MuiStore_1.default), status = _f.status, settings = _f.settings, handleStatusUpdate = _f.handleStatusUpdate, handleStatusAnnouncement = _f.handleStatusAnnouncement, handleStatusDestroy = _f.handleStatusDestroy;
