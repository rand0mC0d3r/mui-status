...
var StyledActionsWrapper = (0, styles_1.styled)('div')(function () { return ({
    padding: '8px',
    display: 'flex',
...
function default_1(_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(MuiStatus_1.default, __assign({}, {
                ...
                : (0, jsx_runtime_1.jsx)(material_1.Popper, __assign({}, __assign({ keepMounted: keepOpen }, FallbackPopoverProps), { children: (0, jsx_runtime_1.jsx)(material_1.ClickAwayListener, __assign({ onClickAway: function () { return handleOnClose(); } }, { children: (0, jsx_runtime_1.jsxs)(StyledContainer, { children: [popover, (0, jsx_runtime_1.jsxs)(StyledActionsWrapper, { children: [(0, jsx_runtime_1.jsx)(StyledTypography, __assign({ variant: "caption", color: "textPrimary" }, { children: popoverTitle })), (0, jsx_runtime_1.jsxs)(StyledActions, { children: [popoverActions, settings.hasLock && (0, jsx_runtime_1.jsx)(Tooltip_1.default, __assign({ tooltip: "Toggle keep-open" }, { children: keepOpen
