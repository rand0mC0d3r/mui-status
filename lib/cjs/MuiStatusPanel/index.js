...
function default_1(_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(MuiStatus_1.default, __assign({}, { id: id, tooltip: tooltip, highlight: highlight, secondary: secondary, onClick: handleOnClick, style: __assign(__assign({}, style), { minWidth: '24px' }) }, { children: children })), popoverComponent !== undefined
                ? popoverComponent(ComponentPopoverProps)
                : (0, jsx_runtime_1.jsx)(material_1.Popper, __assign({}, __assign({ keepMounted: keepOpen }, FallbackPopoverProps), { children: (0, jsx_runtime_1.jsx)(material_1.ClickAwayListener, __assign({ onClickAway: function () { return handleOnClose(); } }, { children: (0, jsx_runtime_1.jsxs)(StyledContainer, __assign({}, { style: { margin: '8px' } }, { children: [popover, (0, jsx_runtime_1.jsx)(StyledLock, __assign({ onClick: function () { return setKeepOpen(!keepOpen); } }, { children: keepOpen
