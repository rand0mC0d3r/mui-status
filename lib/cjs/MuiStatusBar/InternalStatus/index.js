...
function default_1() {
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [status.some(function (sItem) { return !sItem.secondary; }) && (0, jsx_runtime_1.jsx)(StyledPrimaryElem, __assign({}, { id: "".concat(domId, "-primary") })), (0, jsx_runtime_1.jsx)(Tooltip_1.default, __assign({}, { tooltip: 'Toggle console view' }, { children: (0, jsx_runtime_1.jsx)(StyledKeyboardDoubleArrowUpIcon, __assign({}, { onDoubleClick: function () { return updateIsConsoleOpen(); } })) })), status.some(function (sItem) { return sItem.secondary; }) && (0, jsx_runtime_1.jsx)(StyledSecondaryElem, __assign({}, { id: "".concat(domId, "-secondary") }))] });
}
