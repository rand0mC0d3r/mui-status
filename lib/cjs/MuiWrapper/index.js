...
var InternalConsole_1 = __importDefault(require("../MuiStatusBar/InternalConsole"));
...
function default_1(_a) {
    ...
    var _b = (0, react_1.useContext)(MuiStore_1.default), status = _b.status, handleStatusVisibilityToggle = _b.handleStatusVisibilityToggle;
    var _c = (0, react_1.useContext)(MuiStore_1.default).settings, position = _c.position, statusBarAnnounced = _c.statusBarAnnounced, upperBar = _c.upperBar;
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(StyledBox, __assign({ id: "mui-status-wrapper" }, { column: position }, { children: [(0, jsx_runtime_1.jsxs)(StyledChildren, __assign({ id: "mui-status-children" }, { children: [children, status.some(function (_a) {
                                var type = _a.type;
                                return type === 'console';
                            }) && (0, jsx_runtime_1.jsx)(InternalConsole_1.default, {})] })), status.some(function (_a) {
                        var visible = _a.visible;
                        return visible;
                    }) && (0, jsx_runtime_1.jsx)(StyledStatusBar, __assign({ position: position }, { onContextMenu: onContextMenu }, { children: !statusBarAnnounced && (0, jsx_runtime_1.jsx)(InternalStatus_1.default, {}) }))] })), (0, jsx_runtime_1.jsx)(material_1.Popover, __assign({ id: "toggle-status-popover" }, { open: open, anchorEl: anchorEl, onClose: onClose, elevation: 1 }, { anchorOrigin: { vertical: upperBar ? 'top' : 'bottom', horizontal: 'center' }, transformOrigin: { vertical: !upperBar ? 'bottom' : 'top', horizontal: 'center' }, style: { marginTop: "".concat((upperBar ? 1 : -1) * 12, "px") } }, { children: (0, jsx_runtime_1.jsx)(StyledEntryElement, __assign({}, { onContextMenu: function (e) { e.preventDefault(); } }, { children: [false, true].map(function (state) { return (0, jsx_runtime_1.jsx)("div", { children: status.filter(function (_a) {
